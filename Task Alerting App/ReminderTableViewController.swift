...
//  Task Alerting App
//
//  Created by Rajat Rajat on 2020-03-12.
...
class ReminderTableViewController: UITableViewController {
    ...
    */
    ...
    func saveReminders() {
        ...
        if(isSuccessfulSave) {print ("Saved Reminders Successfully")}
        else{ print("failed to save reminders :(")}
    }
    
    func loadReminders() -> [Reminder]? {
        return NSKeyedArchiver.unarchiveObjectWithFile(Reminder.ArchiveURL.path!) as? [Reminder]
    }
